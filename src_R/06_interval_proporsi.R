...
# Menjalankan FUNGSI
hitung_interval_konfidensi(0.5,0.05,100)
hitung_interval_konfidensi(0.5,0.1,100)
hitung_interval_konfidensi(0.5,0.2,100)
hitung_interval_konfidensi(1.2,0.1,100)